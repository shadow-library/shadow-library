 ...
 */
import { Controller, Inject, Injectable, Module, OnApplicationReady, OnModuleDestroy, OnModuleInit, Optional, forwardRef } from '@shadow-library/app';
...
describe('Module', () => {
  ...
  describe('Module Ref', () => {
    ...
    it('should resolve the provider exported from the imported module', async () => {
      ...
      const newModule = new ModuleWrapper(NewModule);
      newModule.addImport(module);
